...
from afpy.gallery.tests.base import FunctionalTestCase
...
# >>> bar.something
from afpy.gallery.tests.globals import *
from afpy.gallery.testing import AFPY_GALLERY_FUNCTIONAL_TESTING as FUNCTIONAL_TESTING
################################################################################
...
def test_suite():
    """."""
    logger = logging.getLogger('afpy.gallery.tests')
    ...
    try:
        ...
        logger.warn('No doctests for afpy.gallery')
