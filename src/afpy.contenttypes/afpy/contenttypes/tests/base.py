...
def setup_product():
    ...
    import afpy.contenttypes
    zcml.load_config('configure.zcml', afpy.contenttypes)
    ...
    ztc.installPackage('afpy.contenttypes')
...
setup_product()
ptc.setupPloneSite(products=['afpy.contenttypes'])
